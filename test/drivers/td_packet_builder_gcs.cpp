...
int main() {
	...
	do {
		...
		Packet_Builder_GCS<TIME>::States initial_state = Packet_Builder_GCS<TIME>::stringToEnum(initial_state_string);

		// Create the output location
		filesystem::create_directories(out_directory.c_str());

		// Instantiate the atomic model to test
		using STATE = Packet_Builder_GCS<TIME>::States;
		shared_ptr<dynamic::modeling::model> packet_builder =
				dynamic::translate::make_dynamic_atomic_model<Packet_Builder_GCS, TIME, STATE>("packet_builder", move(initial_state));
