...
int main() {
	...
	do {
		...
		if (!filesystem::exists(input_file_start_mission) ||
		...
		dynamic::modeling::EOCs eocs_TestDriver = {
				dynamic::translate::make_EOC<On_Route_defs::o_fcc_waypoint_update,o_fcc_waypoint_update>("on_route"),
		};
		...
		dynamic::modeling::ICs ics_TestDriver = {
				...
				dynamic::translate::make_IC<iestream_input_defs<int>::out,On_Route_defs::i_start_mission>("ir_start_mission", "on_route"),
