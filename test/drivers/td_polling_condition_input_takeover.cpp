...
int main(int argc, char* argv[]) {
	...
	do {
		...
		std::shared_ptr<dynamic::modeling::model> polling_condition_input_takeover = dynamic::translate::make_dynamic_atomic_model<Polling_Condition_Input_Pilot_Takeover, TIME, TIME>("polling_condition_input_takeover", std::move(TIME("00:00:00:100")));

		// Instantiate the input readers.
		// One for each input
		std::shared_ptr<dynamic::modeling::model> ir_start =
			dynamic::translate::make_dynamic_atomic_model<Input_Reader_Start_Supervisor, TIME, const char* >("ir_start", std::move(input_file_start.c_str()));
		...
		dynamic::modeling::ICs ics_TestDriver = {
			dynamic::translate::make_IC<iestream_input_defs<message_start_supervisor_t>::out, Polling_Condition_Input_Pilot_Takeover<TIME>::defs::i_start>("ir_start", "polling_condition_input_takeover"),
			dynamic::translate::make_IC<iestream_input_defs<bool>::out, Polling_Condition_Input_Pilot_Takeover<TIME>::defs::i_quit>("ir_quit", "polling_condition_input_takeover")
		};
