...
int main() {
    ...
    do {
        ...
        cadmium::dynamic::modeling::ICs ics_TestDriver = {
                ...
                cadmium::dynamic::translate::make_IC<cadmium::basic_models::pdevs::iestream_input_defs<bool>::out, UDP_Input_Async_defs<message_fcc_command_t>::i_quit>("ir_quit", "udp_input")
        };
