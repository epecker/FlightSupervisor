...
int main(int argc, char* argv[]) {
	...
	do {
		string input_dir = string(PROJECT_DIRECTORY) + string("/test/input_data/command_reposition/") + std::to_string(test_set_enumeration) + string("/");
		...
		shared_ptr<dynamic::modeling::model> ir_request_reposition =
			dynamic::translate::make_dynamic_atomic_model<IR_message_mavlink_mission_item_t, TIME, const char* >("ir_request_reposition", move(input_file_request_reposition.c_str()));
		...
		/*************** Loggers *******************/
		string out_directory = string(PROJECT_DIRECTORY) + string("/test/simulation_results/command_reposition/") + std::to_string(test_set_enumeration) + string("/");
	...
	} while (filesystem::exists(string(PROJECT_DIRECTORY) + string("/test/input_data/command_reposition/") + std::to_string(test_set_enumeration)));
