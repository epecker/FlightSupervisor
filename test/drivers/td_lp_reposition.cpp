...
int main() {
	...
	do {
		...
		cadmium::dynamic::modeling::ICs ics_TestDriver = {
			cadmium::dynamic::translate::make_IC<cadmium::basic_models::pdevs::iestream_input_defs<message_aircraft_state_t>::out,LP_Reposition::defs::i_aircraft_state>("ir_aircraft_state", "lp_reposition"),
			cadmium::dynamic::translate::make_IC<cadmium::basic_models::pdevs::iestream_input_defs<bool>::out,LP_Reposition::defs::i_control_yielded>("ir_control_yielded", "lp_reposition"),
			cadmium::dynamic::translate::make_IC<cadmium::basic_models::pdevs::iestream_input_defs<bool>::out,LP_Reposition::defs::i_hover_criteria_met>("ir_hover_criteria_met", "lp_reposition"),
			cadmium::dynamic::translate::make_IC<cadmium::basic_models::pdevs::iestream_input_defs<bool>::out,LP_Reposition::defs::i_landing_achieved>("ir_landing_achieved", "lp_reposition"),
			cadmium::dynamic::translate::make_IC<cadmium::basic_models::pdevs::iestream_input_defs<message_landing_point_t>::out,LP_Reposition::defs::i_lp_new>("ir_lp_new", "lp_reposition"),
			cadmium::dynamic::translate::make_IC<cadmium::basic_models::pdevs::iestream_input_defs<bool>::out,LP_Reposition::defs::i_pilot_takeover>("ir_pilot_takeover", "lp_reposition"),
			cadmium::dynamic::translate::make_IC<cadmium::basic_models::pdevs::iestream_input_defs<int>::out,LP_Reposition::defs::i_start_mission>("ir_start_mission", "lp_reposition")
		};
