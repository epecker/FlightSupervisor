...
template<typename T>
class Shared_Memory_Input_LP : public Shared_Memory_Input<message_landing_point_t, T> {
public:
...
int main(int argc, char* argv[]) {
	...
	const string o_base_dir = string(PROJECT_DIRECTORY) + string("/test/simulation_results/shared_memory_input/");
