...
int main(int argc, char* argv[]) {
	...
	do {
		...
		string input_file_quit = input_dir + string("/start.txt");
		...
		std::shared_ptr<dynamic::modeling::model> ir_start =
			dynamic::translate::make_dynamic_atomic_model<Input_Reader_Boolean, TIME, const char* >("ir_start", std::move(input_file_quit.c_str()));
