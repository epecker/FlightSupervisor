...
int main() {
	...
	do {
		...
		fstream f;
		f.open(input_file_start_mission, ios::in);
		if (f.is_open()) {
		...
		dynamic::modeling::ICs ics_TestDriver = {
				...
				dynamic::translate::make_IC<iestream_input_defs<message_fcc_command_waypoint_t>::out,Handle_Waypoint_defs::i_waypoint>("ir_waypoint", "handle_waypoint")
		};
