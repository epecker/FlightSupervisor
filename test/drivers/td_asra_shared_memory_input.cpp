...
int main(int argc, char* argv[]) {
	...
	const string o_base_dir = string(PROJECT_DIRECTORY) + string("/test/simulation_results/asra_shared_memory_input/");
	...
	do {
		...
		std::shared_ptr<dynamic::modeling::model> asra_shared_memory_input = dynamic::translate::make_dynamic_atomic_model<ASRA_Shared_Memory_Input, TIME, TIME>("asra_shared_memory_input", std::move(TIME("00:00:00:100")));
		...
		dynamic::modeling::ICs ics_TestDriver = {
			dynamic::translate::make_IC<iestream_input_defs<bool>::out, ASRA_Shared_Memory_Input_defs::i_quit>("ir_quit", "asra_shared_memory_input")
		};
