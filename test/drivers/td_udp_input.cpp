...
#include "../../src/io_models/UDP_Input.hpp"
...
struct out : public out_port<message_fcc_command_t> {};

template<typename TIME>
class UDP_Input_Fcc : public UDP_Input<message_fcc_command_t, TIME> {
public:
    UDP_Input_Fcc() = default;
    UDP_Input_Fcc(TIME poll_rate, bool ack_required, string port) : UDP_Input<message_fcc_command_t, TIME>(poll_rate, ack_required, port){}
};
...
int main() {
	...
	do {
        ...
        std::shared_ptr<dynamic::modeling::model> udp_input = dynamic::translate::make_dynamic_atomic_model<UDP_Input_Fcc, TIME, TIME, bool, const char*>("udp_input", std::move(TIME("00:00:00:100")), true, "23000");

		// Instantiate the input readers.
		// One for each input
        std::shared_ptr<dynamic::modeling::model> ir_message =
                dynamic::translate::make_dynamic_atomic_model<Input_Reader_Fcc_Command, TIME, const char* >("ir_message", input_file_message.c_str());
        std::shared_ptr<dynamic::modeling::model> packet_builder =
                dynamic::translate::make_dynamic_atomic_model<Packet_Builder_Fcc, TIME>("packet_builder");
		...
		dynamic::modeling::ICs ics_TestDriver = {
			dynamic::translate::make_IC<iestream_input_defs<message_fcc_command_t>::out, Packet_Builder_Fcc<TIME>::defs::i_data>("ir_message", "packet_builder"),
			dynamic::translate::make_IC<Packet_Builder_Fcc<TIME>::defs::o_packet, UDP_Output<TIME>::defs::i_message>("packet_builder", "udp_output"),
			dynamic::translate::make_IC<iestream_input_defs<bool>::out, UDP_Input_defs<message_fcc_command_t>::i_quit>("ir_quit", "udp_input")
		};
