...
public:
    ...
    UDP_Input_LP(T poll_rate) : UDP_Input<message_landing_point_t, T>(poll_rate){}
};
...
int main(int argc, char* argv[]) {
	...
	do {
		...
		dynamic::modeling::EOCs eocs_TestDriver = {
            dynamic::translate::make_EOC<UDP_Input_defs<message_landing_point_t>::o_message, out>("udp_input")
        };
