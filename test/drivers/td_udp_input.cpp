...
public:
    ...
    UDP_Input_LP(T poll_rate, bool ack_required, string port) : UDP_Input<message_landing_point_t, T>(poll_rate, ack_required, port){}
};
...
int main(int argc, char* argv[]) {
	...
	do {
		...
		std::shared_ptr<dynamic::modeling::model> udp_input = dynamic::translate::make_dynamic_atomic_model<UDP_Input_LP, TIME, TIME, bool, const char*>("udp_input", std::move(TIME("00:00:00:100")), true, std::move("23000"));
