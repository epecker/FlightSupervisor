...
int main() {
	...
	do {
        ...
        std::shared_ptr<cadmium::dynamic::modeling::model> udp_input = cadmium::dynamic::translate::make_dynamic_atomic_model<UDP_Input_Fcc, TIME, TIME, bool, const char*>("udp_input", std::move(TIME("00:00:00:100")), true, "23000");
