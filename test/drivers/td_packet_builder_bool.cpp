...
int main() {
	...
	do {
		...
		shared_ptr<cadmium::dynamic::modeling::model> packet_builder =
				cadmium::dynamic::translate::make_dynamic_atomic_model<Packet_Builder_Bool, TIME, uint8_t>("packet_builder", SIG_ID_SET_MISSION_MONITOR_STATUS);

		// Instantiate the input readers.
		// One for each input
		shared_ptr<cadmium::dynamic::modeling::model> ir_data =
				cadmium::dynamic::translate::make_dynamic_atomic_model<Input_Reader_Boolean, TIME, const char* >("ir_data", input_file_data.c_str());
		...
		cadmium::dynamic::modeling::EOCs eocs_TestDriver = {
				cadmium::dynamic::translate::make_EOC<Packet_Builder_Bool<TIME>::defs::o_packet,o_packet>("packet_builder")
		};

		// This will connect our outputs from our input reader to the file
		cadmium::dynamic::modeling::ICs ics_TestDriver = {
				cadmium::dynamic::translate::make_IC<cadmium::basic_models::pdevs::iestream_input_defs<bool>::out, Packet_Builder_Bool<TIME>::defs::i_data>("ir_data", "packet_builder")
		};
