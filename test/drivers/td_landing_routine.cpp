...
#include "../../src/atomic_models/Landing_Routine.hpp"
...
int main() {
	...
	do {
		...
		shared_ptr<cadmium::dynamic::modeling::model> landing_routine = cadmium::dynamic::translate::make_dynamic_atomic_model<Landing_Routine, TIME, Landing_Routine<TIME>::States>("landing_routine", std::move(initial_state));
		...
		shared_ptr<cadmium::dynamic::modeling::model> ir_land =
			cadmium::dynamic::translate::make_dynamic_atomic_model<Input_Reader_Mavlink_Mission_Item, TIME, const char* >("ir_land", input_file_land.c_str());
		...
		cadmium::dynamic::modeling::ICs ics_TestDriver = {
			cadmium::dynamic::translate::make_IC<cadmium::basic_models::pdevs::iestream_input_defs<bool>::out,Landing_Routine<TIME>::defs::i_landing_achieved>("ir_landing_achieved", "landing_routine"),
			cadmium::dynamic::translate::make_IC<cadmium::basic_models::pdevs::iestream_input_defs<bool>::out,Landing_Routine<TIME>::defs::i_pilot_takeover>("ir_pilot_takeover", "landing_routine"),
			cadmium::dynamic::translate::make_IC<cadmium::basic_models::pdevs::iestream_input_defs<message_landing_point_t>::out,Landing_Routine<TIME>::defs::i_land>("ir_land", "landing_routine"),
			cadmium::dynamic::translate::make_IC<cadmium::basic_models::pdevs::iestream_input_defs<int>::out,Landing_Routine<TIME>::defs::i_start_mission>("ir_start_mission", "landing_routine")
		};
