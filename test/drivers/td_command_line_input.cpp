...
#include "io_models/Command_Line_Input.hpp"
...
template <typename T>
class Command_Line_Input_message_aircraft_state_t : public Command_Line_Input<message_aircraft_state_t, T> {
    public:
        Command_Line_Input_message_aircraft_state_t() = default;
        Command_Line_Input_message_aircraft_state_t(T poll_rate) : Command_Line_Input<message_aircraft_state_t, T>(poll_rate) {};
};
...
int main(int argc, char* argv[]) {
	...
	do {
		...
		shared_ptr<dynamic::modeling::model> command_line_input = dynamic::translate::make_dynamic_atomic_model<Command_Line_Input_message_aircraft_state_t, TIME, TIME>("command_line_input", move(TIME("00:00:00:100")));
		...
		dynamic::modeling::EOCs eocs_TestDriver = {
			dynamic::translate::make_EOC<Command_Line_Input_defs<message_aircraft_state_t>::out, out>("command_line_input")
		};
