...
int main(int argc, char* argv[]) {
	...
	const string i_base_dir = string(PROJECT_DIRECTORY) + string("/test/input_data/polling_condition_input_test/");
	const string o_base_dir = string(PROJECT_DIRECTORY) + string("/test/simulation_results/polling_condition_input_test/");
