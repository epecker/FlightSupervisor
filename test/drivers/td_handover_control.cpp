...
int main(int argc, char* argv[]) {
	...
	do {
		...
		Handover_Control<TIME>::States initial_state;

		fstream f;
		f.open(input_file_initial_state, ios::in);
		if (f.is_open()) {
			getline(f, initial_state_string);
			initial_state = Handover_Control<TIME>::stringToEnum(initial_state_string);
			f.close();
		}
		...
		dynamic::modeling::ICs ics_TestDriver = {
			...
			dynamic::translate::make_IC<iestream_input_defs<message_landing_point_t>::out,Handover_Control_defs::i_pilot_handover>("ir_pilot_handover", "handover_control"),
