...
int main() {
	...
	do {
		...
		dynamic::modeling::EOCs eocs_TestDriver = {
			dynamic::translate::make_EOC<Handover_Control<TIME>::defs::o_notify_pilot,o_notify_pilot>("handover_control"),
			dynamic::translate::make_EOC<Handover_Control<TIME>::defs::o_control_yielded,o_control_yielded>("handover_control"),
			dynamic::translate::make_EOC<Handover_Control<TIME>::defs::o_stabilize,o_stabilize>("handover_control")
		};
