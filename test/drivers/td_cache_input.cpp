...
public:
    ...
    Cache_Input_LP(message_landing_point_t initial_lp) : Cache_Input<message_landing_point_t, T>(initial_lp){}
};
...
int main(int argc, char* argv[]) {
	...
	do {
		...
		if (!filesystem::exists(input_file_new_input) ||
			!filesystem::exists(input_file_get_input)
		) {
		...
		// One for each input
		std::shared_ptr<dynamic::modeling::model> ir_new_input =
			dynamic::translate::make_dynamic_atomic_model<Input_Reader_Mavlink_Mission_Item, TIME, const char* >("ir_new_input", std::move(input_file_new_input.c_str()));
		std::shared_ptr<dynamic::modeling::model> ir_get_input =
			dynamic::translate::make_dynamic_atomic_model<Input_Reader_Boolean, TIME, const char* >("ir_get_input", std::move(input_file_get_input.c_str()));
		...
		dynamic::modeling::ICs ics_TestDriver = {
			dynamic::translate::make_IC<iestream_input_defs<message_landing_point_t>::out, Cache_Input_defs<message_landing_point_t>::i_new_input>("ir_new_input", "cache_input"),
			dynamic::translate::make_IC<iestream_input_defs<bool>::out, Cache_Input_defs<message_landing_point_t>::i_get_input>("ir_get_input", "cache_input")
		};
