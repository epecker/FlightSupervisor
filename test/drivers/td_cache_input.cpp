...
int main() {
	...
	do {
		...
		std::shared_ptr<dynamic::modeling::model> ir_new_input =
			dynamic::translate::make_dynamic_atomic_model<Input_Reader_Mavlink_Mission_Item, TIME, const char* >("ir_new_input", input_file_new_input.c_str());
		std::shared_ptr<dynamic::modeling::model> ir_get_input =
			dynamic::translate::make_dynamic_atomic_model<Input_Reader_Boolean, TIME, const char* >("ir_get_input", input_file_get_input.c_str());
