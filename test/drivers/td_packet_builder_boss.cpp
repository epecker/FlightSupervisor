...
struct o_packet : public out_port<std::array<char, sizeof(message_boss_mission_update_t)>> {};
...
int main() {
	...
	do {
		...
		shared_ptr<dynamic::modeling::model> ir_data =
				dynamic::translate::make_dynamic_atomic_model<Input_Reader_Boss_Mission_Update, TIME, const char* >("ir_data", input_file_data.c_str());
		...
		dynamic::modeling::EOCs eocs_TestDriver = {
				dynamic::translate::make_EOC<Packet_Builder_Boss<TIME>::defs::o_packet,o_packet>("packet_builder")
		};

		// This will connect our outputs from our input reader to the file
		dynamic::modeling::ICs ics_TestDriver = {
				dynamic::translate::make_IC<iestream_input_defs<message_boss_mission_update_t>::out, Packet_Builder_Boss<TIME>::defs::i_data>("ir_data", "packet_builder")
		};
