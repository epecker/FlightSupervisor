...
int main() {
    ...
    do {
        ...
        std::shared_ptr<cadmium::dynamic::modeling::model> udp_output = cadmium::dynamic::translate::make_dynamic_atomic_model<UDP_Output, TIME, const char *, const unsigned short, bool>(
                "udp_output", IPV4_FCC, PORT_FCC, false);

        // Instantiate the input readers.
        // One for each input
        std::shared_ptr<cadmium::dynamic::modeling::model> ir_message =
                cadmium::dynamic::translate::make_dynamic_atomic_model<Input_Reader_Fcc_Command, TIME, const char *>("ir_message",
                                                                                                           input_file_in.c_str());
        ...
        cadmium::dynamic::modeling::ICs ics_TestDriver = {
                cadmium::dynamic::translate::make_IC<cadmium::basic_models::pdevs::iestream_input_defs<message_fcc_command_t>::out, Packet_Builder_Fcc<TIME>::defs::i_data>(
                        "ir_message", "packet_builder"),
                cadmium::dynamic::translate::make_IC<Packet_Builder_Fcc<TIME>::defs::o_packet, UDP_Output<TIME>::defs::i_message>(
