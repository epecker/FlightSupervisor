...
struct o_packet : public out_port<std::array<char, sizeof(message_fcc_command_t)>> {};
...
int main() {
	...
	do {
		...
		if (!filesystem::exists(input_file_initial_state) ||
			!filesystem::exists(input_file_data)) {
		...
		Packet_Builder_FCC<TIME>::States initial_state = Packet_Builder_FCC<TIME>::stringToEnum(initial_state_string);

		// Create the output location
		filesystem::create_directories(out_directory.c_str());

		// Instantiate the atomic model to test
		using STATE = Packet_Builder_FCC<TIME>::States;
		shared_ptr<dynamic::modeling::model> packet_builder =
				dynamic::translate::make_dynamic_atomic_model<Packet_Builder_FCC, TIME, STATE>("packet_builder", move(initial_state));

		// Instantiate the input readers.
		// One for each input
		shared_ptr<dynamic::modeling::model> ir_data =
				dynamic::translate::make_dynamic_atomic_model<Input_Reader_Fcc_Command, TIME, const char* >("ir_data", input_file_data.c_str());
		...
		dynamic::modeling::EOCs eocs_TestDriver = {
				dynamic::translate::make_EOC<Packet_Builder_FCC<TIME>::defs::o_packet,o_packet>("packet_builder")
		};

		// This will connect our outputs from our input reader to the file
		dynamic::modeling::ICs ics_TestDriver = {
				dynamic::translate::make_IC<iestream_input_defs<message_fcc_command_t>::out, Packet_Builder_FCC<TIME>::defs::i_data>("ir_data", "packet_builder")
		};
