...
int main() {
	...
	do {
		...
		shared_ptr<dynamic::modeling::model> lp_manager = dynamic::translate::make_dynamic_atomic_model<LP_Manager, TIME, TIME, TIME, LP_Manager<TIME>::States>("lp_manager", std::move(lp_accept_time), std::move(orbit_time), std::move(initial_state));
		...
		shared_ptr<dynamic::modeling::model> ir_fcc_command_land =
			dynamic::translate::make_dynamic_atomic_model<Input_Reader_Fcc_Command, TIME, const char* >("ir_fcc_command_land", input_file_fcc_command_land.c_str());
		...
		dynamic::modeling::ICs ics_TestDriver = {
			...
			dynamic::translate::make_IC<iestream_input_defs<bool>::out,LP_Manager<TIME>::defs::i_start_mission>("ir_start_mission", "lp_manager")
		};
