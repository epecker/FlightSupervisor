...
#include "../../src/io_models/UDP_Output_Macos10.hpp"
...
int main() {
	...
	const string i_base_dir = string(PROJECT_DIRECTORY) + string("/test/input_data/udp_output_gcs_macos10/");
	const string o_base_dir = string(PROJECT_DIRECTORY) + string("/test/simulation_results/udp_output_gcs_macos10/");
	...
	do {
		...
		std::shared_ptr<dynamic::modeling::model> udp_output = dynamic::translate::make_dynamic_atomic_model<UDP_Output_Macos10, TIME, const char *, const unsigned short>("udp_output", IPV4_GCS, 14550);
		...
		dynamic::modeling::ICs ics_TestDriver = {
			...
			dynamic::translate::make_IC<Packet_Builder_GCS<TIME>::defs::o_packet, UDP_Output_Macos10<TIME>::defs::i_message>("packet_builder", "udp_output")
		};
